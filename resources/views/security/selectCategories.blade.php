                    ...
                    <div class="form-group{{ $errors->has('first_cat') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <select id="first_cat" class="form-control" name="first_cat" required>
                                ...
                                @for($i=0; $i<24; $i++)
                                    <option value="{{$i}}" {{old('first_cat') == $i ? 'selected': ''}}>{{config('ems.categories')[$i]}}</option>
                                @endfor
                            </select>
                    ...
                    <div class="form-group{{ $errors->has('second_cat') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <select id="second_cat" class="form-control" name="second_cat" required>
                                ...
                                @for($i=0; $i<24; $i++)
                                    <option value="{{$i}}" {{old('second_cat') == $i ? 'selected': ''}}>{{config('ems.categories')[$i]}}</option>
                                @endfor
                            </select>
                    ...
                    <div class="form-group{{ $errors->has('third_cat') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <select id="third_cat" class="form-control" name="third_cat" required>
                                ...
                                @for($i=0; $i<24; $i++)
                                    <option value="{{$i}}" {{old('third_cat') == $i ? 'selected': ''}}>{{config('ems.categories')[$i]}}</option>
                                @endfor
                            </select>
